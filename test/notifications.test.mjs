...
test("clause 10: the route, the versions, the producer pin and the two verbs are in the contracts", () => {
  assert.equal(routes.version, "1.9.0");
  assert.equal(contract.version, "1.10.0");
  assert.equal(contract.producer.source_commit, "69df0ae6cfeef5caada6104f66a98c60a5bda709");
  ...
  assert.equal(contract.mcp_operations.length, 42);
