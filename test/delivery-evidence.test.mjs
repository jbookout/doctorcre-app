...
test("the page offers no command it cannot send, and stays inside the accessibility floor", async () => {
  ...
  assert.equal(routes.version, "1.10.0", "the Control Room route moved this additive contract on");
  assert.equal(carr.version, "1.14.0", "an added HTTP surface is a minor bump of the interface contract");
