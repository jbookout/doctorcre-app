...
test("the page offers no command it cannot send, and stays inside the accessibility floor", async () => {
  ...
  assert.equal(routes.version, "1.7.0", "the Control Room route moved this additive contract on");
  assert.equal(carr.version, "1.7.0", "added verbs are a minor bump of the interface contract");
