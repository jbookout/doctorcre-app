...
test("B05-14 the interface contract pins both verbs alphabetically at 1.18.0 and no route moves", () => {
  ...
  assert.equal(contract.producer.source_commit, "b84cec2ca84c69971bdc28e00f4a8999d09f4f3d", "S02 repinned the producer to the release that first serves the session-identity verbs");
