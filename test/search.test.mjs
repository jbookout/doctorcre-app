...
test("B05-14 the interface contract pins both verbs alphabetically at 1.19.0 and no route moves", () => {
  ...
  assert.equal(contract.producer.source_commit, "3ec74f5749e2739284c8f51d256674fa24e5c7e1", "S02 repinned the producer to the release that first serves the session-identity verbs");
