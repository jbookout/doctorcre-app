...
const required = ["getBoard", "getDeal", "getChanges", "presenceLease", "patchDealField", "resolveConflict", "addDealNote", "setNextStep", "addCriticalDate", "createDeal", "loopBoard", "readLoop", "addLoop", "updateLoop", "closeLoop", "loopHeaders", "commandCenter", "engineeringPassport", "readPortfolio", "workRequestCard", "declineWorkRequest", "supersedeWorkRequest", "setWorkShapeDisposition", "incidentBoard", "currentWorkItem", "currentWorkRequests", "getIncident", "linkIncidentWorkRequest", "notificationFeed", "acknowledgeNotification", "readDocConversation", "listDocConversations", "createDocConversation", "renameDocConversation", "shareDocConversation"];
